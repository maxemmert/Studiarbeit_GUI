...
public class CheckTransaction extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_checktransaction,
				container, false);
		((MainActivity) getActivity()).setTitle("Überweisung prüfen");
		TextView beguenstigter = (TextView) rootView
				.findViewById(R.id.checkBeguenstigter);
		TextView konto = (TextView) rootView
				.findViewById(R.id.checkKontonummer);
		...
		TextView verwendung = (TextView) rootView
				.findViewById(R.id.checkVerwendung);
