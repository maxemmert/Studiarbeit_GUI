...
import com.example.superbank.R.color;
...
public class LoginActivity extends Activity {
	...
	protected void onResume() {
		...
		credentials = getSharedPreferences(MyCREDENTIALS,
				Context.MODE_PRIVATE);
		...
		if (sharedpreferences.contains(name)) {
			if (sharedpreferences.contains(pass)) {
				if (credentials.getString(credentialsN, null).equals(sharedpreferences.getString(name, null))
					&& credentials.getString(credentialsP, null).equals(sharedpreferences.getString(pass, null)) ){
	 ...
	 public void login(View view){
	     ...
	     if (u.equals(credentials.getString(credentialsN, null)) && p.equals(credentials.getString(credentialsP, null)) && 
	    		 !u.equals("") && !p.equals("")) {
	...
	private void alertWrongCredentials() {
		new AlertDialog.Builder(this)
				.setTitle("Meldung")
				.setMessage("Zugangsdaten leer oder fehlerhaft. Bitte erneut versuchen.")
	...
	private void firstOpen() {
		new AlertDialog.Builder(this)
				.setTitle("Willkommen")
				.setMessage("Lieber Nutzer, da dies dein erster Aufruf von SuperBank ist, musst du eine PIN hinterlegen, um deine " +
